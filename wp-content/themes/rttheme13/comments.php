...
$fields =  array(
	'author' =>  '<input id="author" name="author" class="showtextback comment_input" type="text" value="' . $commnet_author . '" size="30"' . $aria_req . ' />',
	'email' =>  '<input id="email" name="email" class="showtextback comment_input" type="text" value="' . $commnet_author_email . '" size="30"' . $aria_req . ' />',
	'url' => '<input id="url" name="url" class="showtextback comment_input" type="text" value="' . $comment_author_url . '" size="30" />'
);
