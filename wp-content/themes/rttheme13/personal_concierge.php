<?php /*Template Name: Personal_Concierge */ ?>
<?php
//page link
...
?>
    ...
    <div class="content sub"> 
        <div class="left">
	<?php $query = new WP_Query('post_type=personal_concierge'); ?>
              <?php while( $query->have_posts() ) : $query->the_post(); ?>
    
            <!-- blog box-->
           <div class="blog single" style="float:left; margin:0 52px;">
               
       
               <?php if(has_post_thumbnail()):?>
               
               <?php if(!$blog_full_width):?>
               <div class="box blog_left first" style="width:225px;">
               <?php endif;?>
               ...
               <!-- / blog image -->
                <h6 style="float:left;"><a href="<?php echo get_permalink() ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a></h6>
